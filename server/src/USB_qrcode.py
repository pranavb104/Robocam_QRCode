# -*- coding: utf-8 -*-
"""
Created on Wed Aug 28 11:31:54 2019
...
""" Main """
f = open('pc_cam_para.txt', 'r')
a = f.read()
pc_cam_para = eval(a)
f.close()
img_result = 'results'
h_camera = 20
pc_mtx = pc_cam_para['pc_mtx']
pc_dist = pc_cam_para['pc_dist']
cap = cv2.VideoCapture(0)

pub = rospy.Publisher('chatter', Float32, queue_size=10)
rospy.Subscriber("take_pic",Int16,callback)
rospy.init_node('USB_qrcode', anonymous=True)
    ...
    if click_pic == 0:
        ...
        if flag_qr == 1:
            ...
            if flag_clarity == 0:
                ...
                devi_dist, delta_x, delta_y = calculate_devi_pos(edge, pc_mtx)
